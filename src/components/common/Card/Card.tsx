...
export const CharacterCard: React.FC<CharacterCardProps> = ({ type }) => {
  ...
  return (
    <div
      className={`flex flex-col items-center rounded-3xl justify-center hover:shadow-lg transition-all duration-300 bg-[#ECF0F4] px-10 py-11 max-w-[400px] max-h-[352px]`}
    >
      {characterType.icon}
